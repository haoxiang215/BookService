...
const app = new Hono()
const supabase = createClient('https://dtmhsvanglgpglrbgorx.supabase.co', 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6ImR0bWhzdmFuZ2xncGdscmJnb3J4Iiwicm9sZSI6ImFub24iLCJpYXQiOjE3Mjk3MDE0OTksImV4cCI6MjA0NTI3NzQ5OX0.CBY0uhb9-9B_4Wp7WpoBTqxA6lxGfHRkonTpSq1sSWY');
